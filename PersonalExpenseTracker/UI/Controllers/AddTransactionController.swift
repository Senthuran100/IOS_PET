...
class AddTransactionController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate, UITextFieldDelegate {
...
"""
        ...
        let doneButton2 = UIBarButtonItem(title: "Done",
                                          ...
                                          target: self,
                                          action: #selector(AddTransactionController.donePicker))

...
class TransactionController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "recordCell", for: indexPath) as? TransactionTableViewCell else {
...
//        cell.icon.image = record.relatedCategory!.iconImage()
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let controller = storyboard.instantiateViewController(withIdentifier: "DisplayRecord") as! ViewTransactionController

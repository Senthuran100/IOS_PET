...
class CategoryController: UITableViewController, NSFetchedResultsControllerDelegate {
...
//        self.view.addGestureRecognizer(longPressRecognizer)
        ...
        segmentioView.setup(
            content: CategoryController.segmentioContent(),
            style: .imageBeforeLabel,
            options: CategoryController.segmentioOptions(segmentioStyle: .imageBeforeLabel)
        )
...
extension CategoryController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "categoryCell", for: indexPath) as! PETCategoryTableCell

        let category = fetchedResultsController.object(at: indexPath)

        cell.setup(model: PETCategoryTableCellModel(
            title: category.name,

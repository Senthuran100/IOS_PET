...
class HomeController: UITableViewController {
    ...
    private var monthYearList = [PETMonth] ()
    ...
    func configureSegmentedView() {
        ...
        segmentioView?.setup(
            ...
            style: .onlyLabel,
            options: HomeController.segmentioOptions(segmentioStyle: .imageBeforeLabel)
        )
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.section == 0 {
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "dashboardCostCell", for: indexPath) as! BudgetTableCell
            cell.selectionStyle = .none
...
extension HomeController: ChartViewDelegate {
